...
import 'package:piano_application/components/small_keyboard.dart';
      ...
      appBar: AppBar(
        ...
        actions: [
          Switch.adaptive(
            ...
            activeColor: const Color.fromARGB(255, 97, 73, 70),
            onChanged: (value) {
              setState(() {
                isShot = !value;
              });
      ...
      drawer: Drawer(
        child: Column(
          children: [
            ...
            const Text('Developed by Elchibek Abdylashymov'),
